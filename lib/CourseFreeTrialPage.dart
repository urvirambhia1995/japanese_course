...
class CourseFreeTrialPage extends StatefulWidget {
  const CourseFreeTrialPage({Key? key}) : super(key: key);

  @override
  State<CourseFreeTrialPage> createState() => _CourseFreeTrialPageState();
}

class _CourseFreeTrialPageState extends State<CourseFreeTrialPage> {
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Text('Course Free Trail',textAlign: TextAlign.center,style: TextStyle(color: Colors.blue.shade900,fontWeight: FontWeight.bold,fontSize: 18),))
                ],
              ),
            ),
            Card(

...
class CourseRefundPloicy extends StatefulWidget {
  const CourseRefundPloicy({Key? key}) : super(key: key);

  @override
  State<CourseRefundPloicy> createState() => _CourseRefundPloicyState();
}

class _CourseRefundPloicyState extends State<CourseRefundPloicy> {
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Text('Course Refund Policy',textAlign: TextAlign.center,style: TextStyle(color: Colors.blue.shade900,fontWeight: FontWeight.bold,fontSize: 18),))
                ],
              ),
            ),
            Card(
